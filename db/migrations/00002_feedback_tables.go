...
func Up00002(tx *sql.Tx) error {
	...
	gormdb.CreateTable(&models.Feedback{}, &models.QuestionResponse{}, &models.ResponseComment{})
	...
	gormdb.Model(&models.TeamFeedbackForm{}).AddForeignKey("role_id", "roles(id)", "RESTRICT", "RESTRICT")
	gormdb.Model(&models.TeamFeedbackForm{}).AddForeignKey("feedback_form_id", "feedback_forms(id)", "RESTRICT", "RESTRICT")
	gormdb.Model(&models.TeamFeedbackForm{}).AddUniqueIndex("unique_team_role", "team_id", "role_id")
	...
	gormdb.Model(&models.ResponseComment{}).AddForeignKey("question_response_id", "question_responses(id)", "RESTRICT",
		"RESTRICT")
...
func Down00002(tx *sql.Tx) error {
	...
	gormdb.Model(&models.ResponseComment{}).RemoveForeignKey("question_response_id", "question_responses(id)")
	...
	gormdb.Model(&models.TeamFeedbackForm{}).RemoveIndex("unique_team_role")
	gormdb.Model(&models.TeamFeedbackForm{}).RemoveForeignKey("feedback_form_id", "feedback_forms(id)")
	gormdb.Model(&models.TeamFeedbackForm{}).RemoveForeignKey("role_id", "roles(id)")
	...
	gormdb.DropTable(&models.Feedback{}, &models.QuestionResponse{}, &models.ResponseComment{})
